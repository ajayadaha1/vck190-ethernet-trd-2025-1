...
set project_name vck190_ethernet_trd_2025_1
...
file mkdir ../Hardware/${project_name}_hw/${project_name}.ipdefs/ 
file copy -force ../Hardware/iprepo ../Hardware/${project_name}_hw/${project_name}.ipdefs/ 
set_property  ip_repo_paths ../Hardware/${project_name}_hw/${project_name}.ipdefs/ [current_project]
update_ip_catalog
